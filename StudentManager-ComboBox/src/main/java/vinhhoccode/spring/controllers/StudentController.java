...
import vinhhoccode.spring.models.Major;
import vinhhoccode.spring.models.MajorDao;
import vinhhoccode.spring.models.Student;
import vinhhoccode.spring.models.StudentDao;
...
public class StudentController {
	...
	public String saveOrUpdate(ModelMap model, @ModelAttribute("STUDENT")Student st) {
		...
		System.out.println("size:" + sdao.ls.size());
		return "student-form";
	}
