...
public class InforController {
	...
	@PostMapping("/save")
	public String save(@RequestParam("name")String name, @RequestParam("photo") MultipartFile photo
		...
		Path path = Paths.get("uploads/"); // lưu trữ các dữ liệu mình up lên trên thư mục này 
		try {
